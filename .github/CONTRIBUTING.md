...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`sec2pri/pysec2pri`](https://github.com/sec2pri/pysec2pri) on
   your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/pysec2pri.git`
...
```shell
$ git remote add sec2pri https://github.com/sec2pri/pysec2pri.git
```
